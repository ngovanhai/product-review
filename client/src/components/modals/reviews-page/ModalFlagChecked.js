...
const ModalFlagChecked = ({
  ...
  const handleSubmit = useCallback(async () => {
    handleChange();
    reload();
    await flagReviewProductsChecked(arrIdProducts);
    // getProductsSearch(
    //   valueSearch,
    //   offset,
    //   selected,
  ...
  const activator = (
    <button id="button-function-detail" onClick={handleChange}>
      Flag as featured all reviews in selected products
    </button>
  );
    ...
    <div>
      ...
      >
        <Modal.Section>
          <TextContainer>
            <p>
              Are you sure you want to flag all reviews in products selected?
            </p>
          </TextContainer>
        </Modal.Section>
      </Modal>
