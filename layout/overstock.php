...
$html .= "<link rel='stylesheet' type='text/css' href='" . $rootLink . "/assets/css/layout-overstock.css?v=" . time() . "' />
...
$html .= genReviewFormLayoutOverstock($shop, $settings)
...
function genReviewFormLayoutOverstock($shop, $settings)
{
