...
$html .= "<link rel='stylesheet' type='text/css' href='" . $rootLink . "/assets/css/layout-masonry.css?v=" . time() . "' />
...
$html .= genReviewFormLayoutMasonry($shop, $settings)
...
if (count($allReviews) > 0) {
    $html .= "<div class='customer-reviews-summary'>
            ...
            <div class = 'box-average' style='background:" . $settings['progress_color'] . "'>
              <h1 class = 'text_inbox' >" . $avarage_point . "</h1>
            </div>
            <div class='text_base_on'>
...
$html .= "<div class='customer-reviews-content'>
    ...
    . "<div class='reviews-list'></div>
                <div><ul id='review_page_navigation' class='pagination-custom'></ul></div>
            </div> 
        </div>";
function genReviewFormLayoutMasonry($shop, $settings)
{
                ...
                <form role='form' enctype='multipart/form-data' id='reviewstform' method='post' name='reviewstform' onsubmit='submitReview(event);return false;'>
                    ...
                    <div id='reviewer_email'>
                        ...
                        <input type='email' name='reviewer_email'
                            ...
                            placeholder='" . $settings["form_email_desc"] . "' required>
                        <div class='ot-err ot-err-email'></div>
                    </div>
                    ...
                    <div id='reviewer_title'>
                        ...
                        <input type='text' name='reviewer_title' placeholder='" . $settings["form_title_desc"] . "' required>
                    </div>
...
// <h4>" . $settings["text_average"] . "</h4>
// <p class='total-review-point' style=color:" . $settings['progress_color'] . ">" . $avarage_point . "/5</p>
// <div class='ratingbox'>
//     <span class='stars-orange' style='width: " . $avarage_review . "%'></span>
// </div><br/>
// <span style='margin-bottom:25px'>(" . $count_review . ")</span>